...
const discovery = {
  ...
  revocationEndpoint: 'https://github.com/settings/connections/applications/6b11402ba7f969234ebd',
};
...
export default function App() {
  ...
  return (
    <>
      ...
      >
        <StyledStripes className="absolute top-0 left-2"/>
        ...
        <Text className="text-center font-body text-xs leading-relaxed text-gray-200">Feito com 💜 no NLW da Rocketseat</Text>
