    ...
    <div className="flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover">
      ...
      <div className="space-y-5">
        ...
        <div className="max-w-[420px] space-y-4">
          ...
          <a href="" className="font-alt inline-block rounded-full bg-green-500 px-5 py-3 text-sm uppercase leading-none text-black hover:bg-green-600">
            CADASTRAR LEMBRANÇA
          </a>
        </div>
      </div>
      ...
      <span className="text-sm leading-relaxed text-gray-200">
        Feito com 💜 no NLW da {' '}
        <a href="#" target="_blank" rel="noreferrer"  className="underline hover:text-gray-100">Rocketseat</a>
      </span>
    ...
    <div className="flex flex-col p-16 bg-[url(../assets/bg-stars.svg)] bg-cover">
      <div className="flex flex-1 items-center justify-center">
        <p className="text-center leading-relaxed w-[360px]">Você ainda não criou nenhuma lembrança, comece a {' '} 
          <a href="http://" className="underline hover:text-gray-50">criar agora!</a>
        </p>
      </div>
    </div>
   </main>
